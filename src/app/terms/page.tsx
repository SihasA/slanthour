  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12 md:py-16">
        ...
        <p className={body}>
          A Keepsake page is a one-time purchase attached to a single published page. It stays
          published for as long as Slanthour exists, and we commit in these terms to at least
          ten years from the date of purchase, independent of any subscription. Slanthour is a
          small studio; we won&apos;t promise forever, so we promise the part we can stand
          behind. You can unpublish, edit or delete your own Keepsake page at any time; doing so
          doesn&apos;t extend or refund the purchase.
        </p>
