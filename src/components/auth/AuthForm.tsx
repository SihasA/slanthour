    ...
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <h1 className="font-heading text-3xl font-light italic text-foreground mb-2 text-center">
          {mode === "signin" ? "Welcome back." : "Start your first page."}
        </h1>
        <p className="font-copy text-sm text-muted text-center mb-10">
          {mode === "signin"
            ? "Sign in to your pages."
            : "Turn photographs into a beautifully designed page."}
        </p>
        ...
        <div className="flex items-center gap-4 my-8" role="separator">
          ...
          <span className="text-[9px] uppercase tracking-label text-muted">or</span>
          <div className="flex-1 h-px bg-rule" />
        </div>
        ...
        <div className="font-copy text-sm text-muted/60 text-center mt-8 space-y-2">
          {mode === "signin" ? (
            <>
              <p>
